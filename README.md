...
- **现代行政区对照**：一键叠加现代行政区，随缩放逐步显示省、市、区县边界与地名，继续放大可看乡镇。点击地图左上的「市界 / 区县界」可直接切换查看层级；鼠标移入区域内部，即可高亮完整轮廓并显示名称。首次经过新区域时联网加载，之后从缓存即时响应。
...
<p align="center">
  <sub>地图数据：Natural Earth · OpenStreetMap / OpenFreeMap / OpenMapTiles · Esri / USGS · Mapzen / AWS<br />
