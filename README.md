...
- **湖泊与遥感核对**：HydroLAKES 湖泊轮廓按视野加载，结合 GeoNames、GDW 补充名称与别名，点击可追溯来源；鄱阳湖、洞庭湖可切换 JRC 遥感水面核对。模型可查询、定位和切换，数据说明见[湖泊来源](docs/LAKE_DATA.md)。
...
<p align="center">
  <sub>地图数据：天地图 · HydroLAKES · GeoNames / GDW · EC JRC/Google · Natural Earth · OpenStreetMap / OpenFreeMap / OpenMapTiles · Esri / USGS · Mapzen / AWS<br />
